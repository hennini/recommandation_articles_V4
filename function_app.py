...
@app.route(route="reco_api_V4")
def reco_api_V4(req: func.HttpRequest) -> func.HttpResponse:
    ...
    if name:
        recommendations = predict_best_category_for_user(name)
        return func.HttpResponse(recommendations,
